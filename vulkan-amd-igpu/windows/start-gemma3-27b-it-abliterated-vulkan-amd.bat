@echo off
REM Gemma 3 27B IT Abliterated Vision Model - Windows Native Vulkan AMD GPU
REM Direct Windows build with enhanced AMD iGPU support

echo 🌋👁️🗿 Starting Gemma 3 27B IT Abliterated - Windows Native Vulkan AMD iGPU...
...
set MODEL_ALIAS=gemma3-27b-it-abliterated-vulkan-amd
